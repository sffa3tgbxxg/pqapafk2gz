...
import { useApiLogsService } from "@/composables/ApiLogsService";
import IconInBox from "@/components/IconInBox.vue";
import PaginationComponent from "@/components/PaginationComponent.vue";
import ApiErrorLogInline from "@/views/logs_pages/ApiErrorLogInline.vue";

export default defineComponent({
  name: "ApiErrorsLogsPage",
  components: {
    ApiErrorLogInline,
    PaginationComponent,
    IconInBox,
  ...
  setup() {
    const settings = useApiLogsService();
    const logs = ref(null);
...
<template>
  <UserTemplate>
    <HeaderPage title="Логи" undertitle="Следите за логами в запросах к API" />
